...
export function MemberRoleSelector({
  ...
  return (
    ...
    >
      <option value={ORGANIZATION_ROLES.MEMBER}>
        {ORGANIZATION_ROLES.MEMBER}
      </option>
      <option value={ORGANIZATION_ROLES.ADMIN}>
        {ORGANIZATION_ROLES.ADMIN}
      </option>
      <option value={ORGANIZATION_ROLES.OWNER}>
        {ORGANIZATION_ROLES.OWNER}
      </option>
      <option value={ORGANIZATION_ROLES.MY_CUSTOM_ROLE}>
